...
public class OldTargetPanel : MonoBehaviour
{
    public static OldTargetPanel Instance;
    ...
    private OldTarget[] _targets ;
    private int _targetLoopIndex;

    private readonly OldTarget[] _level1Target = {
        new(new[] { 0 }, new[] { 10f }),
        new(new[] { 2 }, new[] { 10f }),
...
public readonly struct OldTarget
{
    private readonly int[] _formulaIndex;
    private readonly float[] _timeToCollect;
    public OldTarget(int[] formulaIndex, float[] timeToCollect)
    {
