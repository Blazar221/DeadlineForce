...
//         new(new[] { 0, 1}, new[] { 8f, 15f }, new[]{ItemType.Common, ItemType.Clone}),
//     };

//     private const int Level2LoopIndex = 0;
    
//     private readonly Target[] _level3Target = {
//         new(new[] { 1, 2 }, new[] { 15f, 15f }, new[]{ItemType.Clone, ItemType.Shield}),
//     };
...
//         new(new[] { 0, 1, 2, 3}, new[] { 8f, 15f, 15f, 15f, }, new[]{ItemType.Common, ItemType.Clone, ItemType.Shield, ItemType.Freeze}),
...
//             cd1.fillAmount = 0; cd2.fillAmount = 0; cd3.fillAmount = 0;
//             var cdList = new List<Image>();
//             cdList.Add(cd1); cdList.Add(cd2); cdList.Add(cd3);
